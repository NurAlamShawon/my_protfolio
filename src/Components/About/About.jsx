...
const About = () => {
  ...
  return (
   ...
   <p className="text-black font-regular xl:text-xl text-base text-center p-2">
        ...
        in frontend web development, building responsive and interactive user
        interfaces using HTML, CSS, JavaScript, React, and Tailwind CSS. I enjoy
        transforming creative ideas into functional, user-friendly websites and
        applications that provide real value. In addition to my development
        skills, I have experience in project coordination and academic tutoring,
        which has enhanced my ability to communicate effectively, manage time
        efficiently, and collaborate within a team. I am always eager to take on
        new challenges, explore emerging technologies, and contribute to
